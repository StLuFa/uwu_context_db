    ...
    pub fn extract_pair(tree: &SearchTree) -> Option<CognitivePreferencePair> {
        ...
        Some(CognitivePreferencePair {
            chosen: crate::TrajectorySummary {
                task_id: "lats".into(),
                task_description: "optimal path".into(),
                success: true,
                steps: tree.root.depth,
                contradictions: 0,
                avg_confidence: tree.root.value.composite,
            },
            rejected: crate::TrajectorySummary {
                task_id: "lats".into(),
                task_description: "suboptimal path".into(),
                success: false,
                steps: first_child.depth,
                contradictions: 1,
                avg_confidence: first_child.value.composite,
            },
            ...
            cognitive_delta: CognitiveDelta {
                ...
                confidence_diff: tree.root.value.composite - first_child.value.composite,
                evidence_diff: 0,
